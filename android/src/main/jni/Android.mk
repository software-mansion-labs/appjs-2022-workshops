REACT_NATIVE_APPJS_MAIN_THIS_DIR := $(call my-dir)

include $(REACT_ANDROID_DIR)/Android-prebuilt.mk

include $(REACT_NATIVE_APPJS_MAIN_THIS_DIR)/../../../build/generated/source/codegen/jni/Android.mk

include $(CLEAR_VARS)

LOCAL_PATH := $(REACT_NATIVE_APPJS_MAIN_THIS_DIR)
LOCAL_MODULE := reactnativeappjs_modules
...
LOCAL_SHARED_LIBRARIES := libjsi \
    ...
    libreact_codegen_reactnativeappjs
